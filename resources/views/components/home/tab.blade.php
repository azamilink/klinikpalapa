 <div class="container mx-auto  max-w-4xl mt-[-150px] py-4">
     <div role="tablist" class="tabs tabs-lifted">
         <input type="radio" name="my_tabs_2" role="tab" class="tab text-primary" aria-label="Buat Perjanjian" checked="checked" />
         <div role="tabpanel" class="tab-content bg-primary border-base-300 rounded-box p-6">
             <div class="card bg-primary w-full shrink-0 shadow-2xl">
                 <form class="card-body text-black grid grid-cols-3 gap-1">
                     ...
                     <div class="form-control">
                         <label class="label">
                             <span class="label-text text-white">Jeni Kelamin</span>
                         </label>
                         <input type="email" placeholder="Pria / Wanita" class="input input-bordered" required />
                     </div>
                     <div class="form-control">
                         <label class="label">
                             <span class="label-text text-white">Handphone</span>
                         </label>
                         <input type="email" placeholder="handphone" class="input input-bordered" required />
                     </div>
                     <div class="form-control">
                         <label class="label">
         ...
         <input type="radio" name="my_tabs_2" role="tab" class="tab text-primary" aria-label="Kontak Kami" />
         <div role="tabpanel" class="tab-content grid grid-cols-12 gap-2 bg-primary border-base-300 rounded-box p-6">
